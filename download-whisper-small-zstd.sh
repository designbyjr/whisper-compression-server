...
# Download Whisper Small Model Files and compress with zstd
echo "🔄 Downloading and compressing Whisper Small model files..."
echo "📊 This model provides better accuracy than Tiny"
...
DEST_DIR="public/models/zstd/whisper-small"
...
echo "✅ Whisper Small model download and compression complete!"
